...
public class QuotaIterator extends ApiIterator<QuotaMO, QuotaQuery>
{
    ...
    protected long getConcretCount() throws ApiException
    {
        String relativePath = OpenApiUtils.getOpenApiUtilsInstance()
            .composeRelativeUri(getDeviceId(), "FS_QUOTA", "count");// zwx228053 2014-11-17 参数修改
    ...
    {
        String relativePath = OpenApiUtils.getOpenApiUtilsInstance().composeRelativeUri(getDeviceId(), "FS_QUOTA");// zwx228053 2014-11-17 参数修改
