...
public class NISFieldHandlerImpl extends DefaultCommHandler implements NISFieldHandler
{
    ...
    public void modify(NISFieldMO mo) throws ApiException
    {
        ...
        try
        {
            if (null != mo)
            {
                realitivePath = OpenApiUtils.getOpenApiUtilsInstance().composeRelativeUri(getDeviceId(), "NIS_Config");
    ...
    {
        String realitivePath = OpenApiUtils.getOpenApiUtilsInstance().composeRelativeUri(getDeviceId(), "NIS_Config");
    ...
    {
        String relativePath = OpenApiUtils.getOpenApiUtilsInstance().composeRelativeUri(getDeviceId(), "NIS_Config");
        RestManager<NISFieldMO> restManager = new RestManager<NISFieldMO>(NISFieldMO.class, getRestRequestHandler(),
