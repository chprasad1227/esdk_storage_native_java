 ...
 * 修改时间:  2008-8-18
 * 跟踪单号:  AZ7D01197
 * 修改单号:  AZ7D01197　【B019-告警性能-自动化】清空当前告警，关闭告警管理，再进入告警管理，点击历史告警，出现系统操作失败
 * 修改内容:　增加常量字符串 EXCEL_SEPEARATOR[xls分割符] CSV_SEPEARATOR［CSV分割符］ ALARM_ATTRIBUTE_SEPEARATOR［alarm文件中属性分割符］
 *
 * 修 改 人:  y90003176
 * 修改时间:  2009-6-26
 * 修改内容:  修改告警内容结构，提供V1R1的#???结构和V1R2的##\\d{2}结构支持
 */
...
public class IsmConstant
{
    ...
    /** 公共属性PASSWORD_MASK */
    public static final String PWD_MASK = "********";
