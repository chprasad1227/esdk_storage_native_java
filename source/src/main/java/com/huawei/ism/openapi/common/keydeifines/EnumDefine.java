...
public class EnumDefine
{
    ...
    public static enum HOTSPARE_SPACE_STRATEGY_E
    {
        ...
        public int compareEnum(HOTSPARE_SPACE_STRATEGY_E oldValue)
        {
            return 0;
            /*
             * int newValueNum = 0; int oldValueNum = 0; switch (this.value) { case 1: newValueNum =
             * IsmConstant.CONST_TWO; break; case MagicNumber.INT2: newValueNum = IsmConstant.CONST_THREE; break; case
             * MagicNumber.INT3: newValueNum = IsmConstant.CONST_ONE; break; default: break; } switch (oldValue.value) {
             * case 1: oldValueNum = IsmConstant.CONST_TWO; break; case MagicNumber.INT2: oldValueNum =
             * IsmConstant.CONST_THREE; break; case MagicNumber.INT3: oldValueNum = IsmConstant.CONST_ONE; break;
             * default: break; } if (newValueNum > oldValueNum) { return 1; } else if (newValueNum < oldValueNum) {
