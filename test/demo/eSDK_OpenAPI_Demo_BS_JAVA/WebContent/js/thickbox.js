...
var tb_pathToImage = "/eSDK_OpenAPI_Demo_BS_JAVA/image/loadingAnimation.gif";
...
function tb_remove() {
	...
	//刷新数量显示
	getcount("diskPoolCount");
	getcount("storagePoolCount");
	getcount("lunCount");
	getcount("hostCount");
	getcount("lunGroupCount");
	getcount("hostGroupCount");
	getcount("portGroupCount");
	getcount("mappingViewCount");
	return false;
}
